...
import { Card,CardBody,Button,Col,Container,Input,Label,Tooltip,Nav,NavItem,NavLink,Row,TabContent,TabPane,} from "reactstrap";
import BreadCrumb from "./BreadCrumb";

import product29 from "./img-29.jpg";
import product30 from "./img-30.jpg";
import product31 from "./img-31.jpg";
import product32 from "./img-32.jpg";
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      ...
                      <div className="mt-4 text-muted">
                        ...
                        <p>
                        aspirateur robot à chargement automatique, aspiration 2800 Pa, fin,
                        idéal pour les sols durs, les tapis, noir.
                         </p>
                      </div>
                          ...
                          <div className="mt-3">
                            ...
                            <ul className="list-unstyled">
                              <li className="py-1">
                                ...
                                double fonctionnalité de nettoyage
                              </li>
                              <li className="py-1">
                                <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i>{" "}
                              ...
                              <li className="py-1">
                                <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i>{" "}
                                Sessions de nettoyage prolongées
                        ...
                        >
                          ...
                          >
                            <div>
                              ...
                              Robot Aspirateur Mollie
                              </h5>
                              <p>
                              Robot aspirateur et vadrouille avec Wi-Fi/application,
                              aspirateur robot à chargement automatique, <br/>
                              aspiration 2800 Pa, fin, idéal pour les sols durs, les tapis, noir
                              </p>
                              <div>
                                <p className="mb-2">
                                  <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i>{" "}
                                  Connectivité intelligente avec Tuya WIFI
                                ...
                                <p className="mb-2">
                                  <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i>{" "}
                                  Cartographie avancée et GYRO de haute précision
                                </p>
                                <p className="mb-0">
                                  <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i>{" "}
                                  FACILE À NETTOYER
