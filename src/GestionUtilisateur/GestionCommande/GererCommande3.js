...
import {Button,Card,CardBody,Col,Container, Tooltip,Nav,NavItem,NavLink,Row,TabContent,TabPane,} from "reactstrap";

//import BreadCrumb from "../../../Components/Common/BreadCrumb";
import BreadCrumb from "./BreadCrumb";

import product1 from "./img-15.jpg";
import product6 from "./img-16.jpg";
import product8 from "./img-17.jpg";
//import product1 from "../../../assets/images/products/img-15.png";
//import product6 from "../../../assets/images/products/img-16.png";
//import product8 from "../../../assets/images/products/img-17.png";
                  ...
                  <Col xl={8}>
                    <div className="mt-xl-0 mt-5">
                      <div className="d-flex">
                        <div className="flex-grow-1">
                          <h4>SVR Pack Sebiaclear Peaux Grasses Gel - 200 Ml - Eau Micellaire - 400 Ml - Serum</h4>
                      ...
                      <div className="mt-4 text-muted">
                        ...
                        <p>
                        LE pack est composé de :<br/>

                        *gel moussant sebiaclear 200ml<br/>

                        *eau micellaire sebiaclear 400ml<br/>

                        *SVR SEBIACLEAR SERUM 30ML.
                        </p>
                      </div>
                        ...
                        >
                          ...
                          >
                            <div>
                              ...
                              SVR Pack Sebiaclear Peaux Grasses Gel - 200 Ml - Eau Micellaire - 400 Ml - Serum
                              </h5>
                              <p>
                              SVR Sebiaclear Gel Moussant :<br/>
                              Idéal pour les peaux sensibles mixtes à grasses.<br/>
                               Élimine impuretés et excès de sébum, resserre les pores.<br/>
                                À utiliser matin et soir.<br/>
                                SVR Sebiaclear Eau Micellaire :<br/>
                                Purifie, matifie, démaquille les peaux grasses sans rinçage. Sans paraben, alcool, savon.<br/>
                                SVR Sebiaclear Serum 30ml :<br/>
                                Réduit boutons, points noirs, pores, marques. Utilisez matin/soir sur visage.
                              </p>
                              <div>
                                <p className="mb-2">
                                  <i className="mdi mdi-circle-medium me-1 text-muted align-middle"></i>{" "}
